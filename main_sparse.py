...
hyperparameter_string=  "Alpha:{}; Batch_size:{}; Num_epochs:{}; Corruption:{}; Hidden_layers: {}; Penalty:{}; Sparsity:{}; Momentum:{} ".format(str(auto_enc_hyperparameters[0]), str(auto_enc_hyperparameters[1]), str(auto_enc_hyperparameters[2]), str(auto_enc_hyperparameters[3][0]),str(auto_enc_hyperparameters[4]), penalty_parameter, sparsity_constraint, pretraining_mom)
...
os_dir = "./plots_part2/q2/sparse_hyperparameters:{}".format(hyperparameter_string)
if(os.path.exists(os_dir)):
    os_dir = "./plots_part2/q2/2ndRUN_sparse_hyperparameters:{}".format(hyperparameter_string)
    os.makedirs(os_dir)
else:
    os.makedirs(os_dir)
plots_dir = os_dir
